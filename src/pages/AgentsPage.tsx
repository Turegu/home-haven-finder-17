  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="relative h-32 md:h-40 overflow-hidden">
        <img
          src="https://images.unsplash.com/photo-1486325212027-8081e485255e?w=1400&h=300&fit=crop"
          alt="Agents banner"
                ...
                <div className="p-5 relative">
                  <div className="absolute -top-8 left-5">
                    <img
                      src={company.logo}
                      alt={company.name}
                      className="w-16 h-16 rounded-lg border-2 border-background object-cover shadow-sm"
                    />
                  </div>
                  <div className="mt-6">
                  ...
                  <div className="mt-3 flex flex-wrap gap-1">
                    {company.serviceAreas.slice(0, 3).map((area) => (
                      <span key={area} className="text-xs bg-secondary text-secondary-foreground px-2 py-0.5 rounded-full">
                        {area}
                      </span>
                    ))}
                  </div>
              ...
              >
                ...
                <div className="mt-3 flex flex-wrap justify-center gap-1">
                  {agent.languages.slice(0, 3).map((lang) => (
                    <span key={lang} className="text-xs bg-secondary text-secondary-foreground px-2 py-0.5 rounded-full">
                      {lang}
                    </span>
                  ))}
                </div>
