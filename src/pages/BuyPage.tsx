      ...
      <div className="flex flex-col md:flex-row bg-card rounded-xl border border-border overflow-hidden shadow-sm hover:shadow-md transition-all group">
        <div className="relative w-full md:w-[360px] aspect-[4/3] md:aspect-auto md:h-auto shrink-0 overflow-hidden">
          ...
          <div className="absolute top-2 right-2 flex gap-1.5">
            <button className="bg-background/90 hover:bg-background text-foreground/70 hover:text-primary p-1.5 rounded-full shadow-sm text-xs font-medium px-2">Compare</button>
            <button className="bg-background/90 hover:bg-background text-foreground/70 hover:text-destructive p-1.5 rounded-full shadow-sm text-xs font-medium px-2">♡ Favorite</button>
          </div>
        </div>
