...
import { Eye, EyeOff, X, MailWarning } from "lucide-react";
        ...
        >
          ...
          {emailNotVerified ? (
            <div className="text-center space-y-4 py-4">
              <MailWarning className="h-10 w-10 text-orange-500 mx-auto" />
              <h2 className="text-base font-semibold text-foreground">Email Not Verified</h2>
