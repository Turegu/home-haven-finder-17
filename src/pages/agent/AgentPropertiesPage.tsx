// Agent wrapper pages - these reuse company page logic with AgentLayout
// We create thin wrapper components that swap the layout
...
import { Search, MoreVertical, Pencil, Eye } from "lucide-react";
  ...
  useEffect(() => {
    const fetch = async () => {
      ...
      const { data, error } = await supabase
        .from("properties")
        .select("id, listing_id, title, property_type, property_purpose, status, price, currency, created_at")
