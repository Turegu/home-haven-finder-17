  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div
        ...
        style={{
          backgroundImage: 'url(https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=1600&h=600&fit=crop)',
        }}
      >
        <div className="absolute inset-0 bg-black/60" />
        <div className="relative text-center text-white z-10 px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">You Dream it, We Find it</h1>
          <p className="text-lg opacity-90 mb-1">You didn't find your dream home you looking for?</p>
          <p className="text-lg opacity-90">Let our network of top agents in the country find it for you</p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground">Handpicked properties by our team</p>
        </div>
      ...
      <div className="container mx-auto px-4 pb-16">
        <div className="max-w-4xl mx-auto bg-card border border-border rounded-xl p-6 md:p-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            ...
            <div>
              <label className="block text-sm font-medium text-foreground mb-1.5">Area, Street*</label>
              <Input
                value={formData.areaStreet}
                onChange={(e) => handleChange('areaStreet', e.target.value)}
            ...
            <div>
              <label className="block text-sm font-medium text-foreground mb-1.5">Area (M²)*</label>
              <Input
            ...
            <div>
              <label className="block text-sm font-medium text-foreground mb-1.5">Rooms*</label>
              <Input
