        ...
        <div className="container mx-auto px-4 py-12">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="text-center md:text-start">
              <h3 className="text-2xl font-bold mb-2">{t('footer.getApp')}</h3>
              <p className="text-white/60 text-sm max-w-md">
                {t('footer.getAppDescription')}
              </p>
            </div>
            <div className="flex items-center gap-4">
              <a href="#" className="flex items-center gap-3 bg-white/10 hover:bg-white/20 rounded-lg px-5 py-3 cursor-pointer transition-colors">
                ...
                <div>
                  <p className="text-[10px] text-white/60 leading-none">{t('footer.downloadAppStore')}</p>
              ...
              <a href="#" className="flex items-center gap-3 bg-white/10 hover:bg-white/20 rounded-lg px-5 py-3 cursor-pointer transition-colors">
                ...
                <div>
                  <p className="text-[10px] text-white/60 leading-none">{t('footer.getItOn')}</p>
      ...
      <div className="container mx-auto px-4 py-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/60">
              <li><Link to="/advertise" className="hover:text-white transition-colors">{t('footer.aboutUs')}</Link></li>
              <li><Link to="/advertise" className="hover:text-white transition-colors">{t('nav.advertiseWithUs')}</Link></li>
              <li><Link to="/advertise" className="hover:text-white transition-colors">{t('footer.contact')}</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="font-semibold text-sm mb-4">{t('footer.explore')}</h4>
            <ul className="space-y-2 text-sm text-white/60">
              <li><Link to="/buy" className="hover:text-white transition-colors">{t('nav.buy')}</Link></li>
              <li><Link to="/rent" className="hover:text-white transition-colors">{t('nav.rent')}</Link></li>
              <li><Link to="/projects" className="hover:text-white transition-colors">{t('nav.projects')}</Link></li>
              <li><Link to="/agents" className="hover:text-white transition-colors">{t('nav.agents')}</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/60">
              ...
              <li><Link to="/mortgage-bank-loan" className="hover:text-white transition-colors">{t('footer.mortgageBanks')}</Link></li>
              <li><Link to="/property-request" className="hover:text-white transition-colors">{t('nav.propertyRequest')}</Link></li>
            </ul>
          </div>
          <div>
        ...
        <div className="mt-10 pt-6 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-white/40">© 2026 {t('footer.allRightsReserved')}</span>
          </div>
