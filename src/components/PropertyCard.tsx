      ...
      <div className="relative aspect-[4/3] overflow-hidden bg-muted">
        ...
        <div className="absolute top-2 right-2 flex gap-1.5">
          <button
            ...
            className={`p-1.5 rounded-full transition-colors shadow-sm ${isCompared ? 'bg-primary text-primary-foreground' : 'bg-background/90 hover:bg-background text-foreground/70 hover:text-primary'}`}
            aria-label="Compare"
          >
