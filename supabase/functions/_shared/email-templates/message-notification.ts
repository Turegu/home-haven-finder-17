// Template 5: Message notification (from agent profile contact)
...
export function messageNotificationTemplate(data: {
  ...
  const body = `
    <div style="display:flex;align-items:center;gap:8px;margin-bottom:16px;">
      <span style="font-size:22px;font-weight:700;color:#262626;">A Message</span>
    </div>

    <p style="margin:0 0 16px;font-size:15px;">
      <strong style="color:#009688;">${data.senderName}</strong> sent you a message.
    </p>
